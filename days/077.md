...
4. Login into Storage server and install java
    ...
    > Add the permission of `/var/www/html` directory:  # "Perform this step before Step 3, as it prevents the error: 'This agent is offline because Jenkins failed to launch the agent process on it.'
